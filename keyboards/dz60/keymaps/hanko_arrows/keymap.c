 ...
 */
  ...
  LAYOUT_2_shifts(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_RGUI, MO(1), KC_LEFT, KC_DOWN, KC_RIGHT
      ),
 ...
 */
  ...
  LAYOUT_directional(
      ...
      ______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, ______, ______, KC_HOME, KC_PGUP, ______, ______, ______,
      ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_END, KC_PGDN, ______, ______, KC_RCTL, ______,
